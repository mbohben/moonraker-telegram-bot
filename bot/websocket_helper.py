...
class WebSocketHelper:
    def __init__(
        ...
        self._use_power_devices: bool = bool(
            config.bot_config.light_device_name
            or config.bot_config.poweroff_device_name
            or config.status_message_content.moonraker_devices
        )
